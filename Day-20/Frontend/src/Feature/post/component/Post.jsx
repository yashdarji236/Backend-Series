...
const post = ({user , post , loading , handleLiked , handleunLiked}) => {
  ...
  return (
    <div className="post">
                    ...
                    <div className="btn">
                    <p className="captiom">{post.caption}</p>
                    </div>
                </div>  
  )
}
