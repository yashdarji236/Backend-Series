          ...
          <div className="form-animate relative z-10 w-full" style={{ maxWidth: '400px' }}>
            <div className="flex items-center gap-3 mb-9">
              <div className="flex items-center gap-2">
                <h1 className="text-[28px] font-bold text-[#e8e8f0]">Create your account</h1>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-[7px]">
                  <label htmlFor="text" className="text-[11px] font-semibold uppercase tracking-[1px]" style={{ color: '#a0a0a0' }}>
                    Username
                  </label>
                  <div className="field-wrap relative">
                    ...
                    <input type="text" id="text" name="text" placeholder="Enter your username" required
            ...
            <div className="flex items-center my-6">
              <div className="flex-1 h-[1px]" style={{ background: '#303232' }}></div>
              <span className="px-4 text-[13px] uppercase tracking-wide font-medium" style={{ color: '#606060' }}>or</span>
              <div className="flex-1 h-[1px]" style={{ background: '#303232' }}></div>
            </div>

            <a href="http://localhost:3000/api/auth/google" 
               className="w-full flex items-center justify-center gap-3 rounded-full text-[15px] font-medium cursor-pointer transition-all duration-200"
               style={{ background: '#202222', color: '#e8e8f0', border: '1px solid #404040', padding: '11px', textDecoration: 'none' }}
               onMouseEnter={e => { e.currentTarget.style.background = '#303232'; e.currentTarget.style.borderColor = '#606060'; }}
               onMouseLeave={e => { e.currentTarget.style.background = '#202222'; e.currentTarget.style.borderColor = '#404040'; }}
            >
            ...
            <p className="text-center mt-6 text-[14px]" style={{ color: '#a0a0a0' }}>
              ...
              <Link to="/login" className="font-medium transition-colors duration-200" style={{ color: '#e8e8f0', textDecoration: 'none' }}
