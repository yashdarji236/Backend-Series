          ...
          <div className="form-animate relative z-10 w-full" style={{ maxWidth: '400px' }}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-4">
                ...
                <label htmlFor="text" className="font-sora text-[10px] font-semibold uppercase tracking-[1.6px]" style={{ color: 'rgba(232,232,240,0.28)' }}>
                  Username
                </label>
            ...
            <p className="font-sora text-center mt-6 text-[13px] font-light" style={{ color: 'rgba(232,232,240,0.3)' }}>
              ...
              <Link to="/login" className="font-medium transition-colors duration-200" style={{ color: '#20d9d2', textDecoration: 'none' }}
